...
//   - sys.signal("p4_bg_app", ...) の名前解決と投函 (sig=1 が publish に
//     乗る。受信側の print はデバイスのコンソールに [p4_bg_app] 行で出る)
"use strict";
sys.setAppName("p4_dev_probe");
...
setInterval(function () {
    n++;
    if (n <= 3)
        sigOk = sys.signal("p4_bg_app", "ping#" + n) ? 1 : 0;
    if (mqtt.connected())
