/*
 * TweetNaCl - Ed25519 signature verification subset.
 * Public domain (Daniel J. Bernstein, Bernard van Gastel, Wesley Janssen,
 * Tanja Lange, Peter Schwabe, Sjaak Smetsers). https://tweetnacl.cr.yp.to/
 *
 * Trimmed to crypto_sign_open() and its dependencies (SHA-512 + the
 * Curve25519/Edwards arithmetic). Verification is deterministic, so no
 * randombytes() is needed.
 */
#include "tweetnacl.h"
...
static const gf D = {0x78a3, 0x1359, 0x4dca, 0x75eb, 0xd8ab, 0x4141, 0x0a4d,
